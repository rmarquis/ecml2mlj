function predict_fourCriteria(dataSelection)

% predict without Poisson-OD-Sampling;
% predict on four criteria including the Brier score
...
if dataSelection == 1 || dataSelection == 3
    ...
    resultFinal_BrierScore = cell( length(trainingPercentageVar), numberOfYear);
    idxTraining = 0;
    for trainingPercentage = trainingPercentageVar        
        ...
        for idxYear = 1:numberOfYear;
            ...
            [tempInfoGain tempWLD tempSkill tempScoreAccuracy temppredictedWinResult tempBrierScore] = computeThreeMeasure_AllScoreDifference(matchOutcome, trainingPercentage, testPercentage, flagHalo); % the last parameter 0 indicating the data set is not Halo
            ...
            resultFinal_BrierScore{idxTraining, idxYear} = tempBrierScore;
...
if dataSelection == 1
    ...
    resultFinal_BrierScore_AFL = resultFinal_BrierScore; 
    save resultFinal_BrierScore_AFL.mat resultFinal_BrierScore_AFL;
elseif dataSelection == 2
    ...
    resultFinal_BrierScore_Halo = resultFinal_BrierScore; 
    save resultFinal_BrierScore_Halo.mat resultFinal_BrierScore_Halo;    
elseif dataSelection == 3
    ...
    resultFinal_BrierScore_UK = resultFinal_BrierScore; 
    save resultFinal_BrierScore_UK.mat resultFinal_BrierScore_UK;
end

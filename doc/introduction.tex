...
In this work\footnote{Part of this work appeared in~\cite{Guo:ECML2012}.}, we augment the TrueSkill model of WLD skill learning to
...
approximate Bayesian inference in the latter case. Additionally, we model home field advantage in some of the proposed models to reflect the possibly better performance when playing on home fields for real-world matches such as football, and we show that modeling of home advantages can be naturally integrated into our proposed graphical models. We evaluate these novel Bayesian score-based skill-learning models in comparison to TrueSkill (for WLD outcomes) on three datasets: 14 years of match
...
accuracy, and (c) provide reasonably accurate score predictions with an appropriate

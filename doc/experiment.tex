...
In terms of win/no-win prediction accuracy on the three data sets (Figure~\ref{fig:WLAccuracy_UK}, Figure~\ref{fig:WLAccuracy_AFL}, and Figure~\ref{fig:WLAccuracy_Halo}), the Gaussian-OD model generally provides the best average AUC, followed by Gaussian-SD, then

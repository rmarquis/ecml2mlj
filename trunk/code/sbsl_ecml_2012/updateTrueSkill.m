function [teamISkill teamJSkill] = updateTrueSkill( teamISkill, teamJSkill, scoreI, scoreJ, beta, epsilon  )
...
%     end    
    ...
    if noTeams == 2
       ...
       [varBag, MessageBag] = UpdateHelperGaussianWeightedSumFactor(weight0, weight0Squared, m1, m2, m3, MessageBag, ...
                                                                                              v1, v2, v3, varBag);
       % Send greater than or within factor
       % TODO: replace the greater than factor with Poisson factor
       [varBag, MessageBag] = UpdateHelperGreaterThanOrWithinFactors(isDraw, numberOfMessages, MessageBag, numberOfVariables, varBag, epsilon);
    else
